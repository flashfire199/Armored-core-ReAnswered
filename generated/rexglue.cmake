...
# Codegen target - run 'cmake --build . --target acre_codegen'
add_custom_target(acre_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/acre_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for acre"
    VERBATIM
)
